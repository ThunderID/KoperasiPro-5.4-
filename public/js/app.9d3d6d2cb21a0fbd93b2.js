...
*/
window.NProgress = __webpack_require__(28);
NProgress.configure({
  showSpinner: false,
  trickleSpeed: 300
});
 ...
 */
window.steps = __webpack_require__(24);
$(document).ready(function () {
  wizard();
});
 ...
 */
window.validate = __webpack_require__(25);
 ...
 */
window.cookies = __webpack_require__(22);
$(document).ready(function () {
  window.cookies();
});
...
*/
window.inputmask = __webpack_require__(21);
// class for inputmask
$(document).ready(function () {
 ...
 */
window.quickselect = __webpack_require__(23);
...
//  */
window.select2 = __webpack_require__(30);
$(document).ready(function () {
  // window.select();
});
 ...
 */
window.nicescroll = __webpack_require__(27);
 ...
 */
window.list = __webpack_require__(26);
 ...
 */
window.bootstrapSwitch = __webpack_require__(20);
$(document).ready(function () {
...
!function ($) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function getLastValidPosition(closestTo, strict, validPositions) {
            ...
            for (var posNdx in valids) {
                ...
                valids[psNdx] && (strict || valids[psNdx].generatedInput !== !0) && (psNdx <= closestTo && (before = psNdx), psNdx >= closestTo && (after = psNdx));
            }
        ...
        function checkAlternationMatch(altArr1, altArr2, na) {
            for (var naNdx, altArrC = opts.greedy ? altArr2 : altArr2.slice(0, 1), isMatch = !1, naArr = void 0 !== na ? na.split(",") : [], i = 0; i < naArr.length; i++) {
        ...
        function isValid(pos, c, strict, fromSetValid, fromAlternate) {
            ...
            function trackbackAlternations(originalPos, newPos) {
                ...
                if (vp) for (var targetLocator = vp.locator, tll = targetLocator.length, ps = originalPos; ps < newPos; ps++) {
                    if (void 0 === getMaskSet().validPositions[ps] && !isMask(ps, !0)) {
                        ...
                        }), bestMatch.generatedInput = !0, setValidPosition(ps, bestMatch, !0), getMaskSet().validPositions[newPos] = void 0, _isValid(newPos, vp.input, !0);
                    }
                }
            }
            ...
            function fillMissingNonMask(maskPos) {
                ...
                for (pndx++; pndx < maskPos; pndx++) {
                    void 0 === getMaskSet().validPositions[pndx] && (opts.jitMasking === !1 || opts.jitMasking > pndx) && (testsFromPos = getTests(pndx, getTestTemplate(pndx - 1).locator, pndx - 1).slice(), "" === testsFromPos[testsFromPos.length - 1].match.def && testsFromPos.pop(), testTemplate = determineTestTemplate(testsFromPos), testTemplate && (testTemplate.match.def === opts.radixPointDefinitionSymbol || !isMask(pndx, !0) || $.inArray(opts.radixPoint, getBuffer()) < pndx && testTemplate.match.fn && testTemplate.match.fn.test(getPlaceholder(pndx), getMaskSet(), pndx, !1, opts)) && (result = _isValid(pndx, getPlaceholder(pndx, testTemplate.match, !0) || (null == testTemplate.match.fn ? testTemplate.match.def : "" !== getPlaceholder(pndx) ? getPlaceholder(pndx) : getBuffer()[pndx]), !0), result !== !1 && (getMaskSet().validPositions[result.pos || pndx].generatedInput = !0)));
                }
            }
            strict = strict === !0;
            var maskPos = pos;
            ...
            if (fillMissingNonMask(maskPos), isSelection(pos) && (handleRemove(void 0, Inputmask.keyCode.DELETE, pos), maskPos = getMaskSet().p), maskPos < getMaskSet().maskLength && (result = _isValid(maskPos, c, strict), (!strict || fromSetValid === !0) && result === !1)) {
                ...
                if (!currentPosValid || null !== currentPosValid.match.fn || currentPosValid.match.def !== c && c !== opts.skipOptionalPartCharacter) {
                    if ((opts.insertMode || void 0 === getMaskSet().validPositions[seekNext(maskPos)]) && !isMask(maskPos, !0)) for (var nPos = maskPos + 1, snPos = seekNext(maskPos); nPos <= snPos; nPos++) {
        ...
        function renderColorMask(input, buffer, caretPos) {
            function handleStatic() {
                isStatic || null !== test.fn && void 0 !== testPos.input ? isStatic && null !== test.fn && void 0 !== testPos.input && (isStatic = !1, maskTemplate += "</span>") : (isStatic = !0, maskTemplate += "<span class='im-static''>");
            }
            if (void 0 !== colorMask) {
    ...
    return Inputmask.prototype = {
        ...
        mask: function mask(elems) {
            ...
            return "string" == typeof elems && (elems = document.getElementById(elems) || document.querySelectorAll(elems)), elems = elems.nodeName ? [elems] : elems, $.each(elems, function (ndx, el) {
                ...
                void 0 !== maskset && (void 0 !== el.inputmask && el.inputmask.remove(), el.inputmask = new Inputmask(void 0, void 0, !0), el.inputmask.opts = scopedOpts, el.inputmask.noMasksCache = that.noMasksCache, el.inputmask.userOptions = $.extend(!0, {}, that.userOptions), el.inputmask.isRTL = that.isRTL, el.inputmask.el = el, el.inputmask.maskset = maskset, $.data(el, "_inputmask_opts", scopedOpts), maskScope.call(el.inputmask, {
                    action: "mask"
                }));
        ...
        numeric: {
            ...
            postFormat: function postFormat(buffer, pos, opts) {
                ...
                var charAtPos = buffer[pos],
                    cbuf = buffer.slice();
                charAtPos === opts.groupSeparator && pos > opts.prefix.length && pos < buffer.length - opts.suffix.length && (cbuf.splice(pos--, 1), charAtPos = cbuf[pos]);
            ...
            leadingZeroHandler: function leadingZeroHandler(chrs, maskset, pos, strict, opts, isSelection) {
                if (!strict) {
                    var initialPos = pos,
                        buffer = opts.numericInput === !0 ? maskset.buffer.slice("").reverse() : maskset.buffer.slice("");
                    opts.numericInput && (pos = buffer.join("").length - pos - 1), buffer.splice(0, opts.prefix.length), buffer.splice(buffer.length - opts.suffix.length, opts.suffix.length), pos -= opts.prefix.length;
                    ...
                    if (matchRslt && (radixPosition === -1 || pos <= radixPosition || opts.numericInput)) {
                        var decimalPart = radixPosition === -1 ? 0 : parseInt(buffer.slice(radixPosition + 1).join("")),
                            leadingZero = 0 === matchRslt[0].indexOf("" !== opts.placeholder ? opts.placeholder.charAt(0) : "0");
            ...
            definitions: {
                "~": {
                    validator: function validator(chrs, maskset, pos, strict, opts, isSelection) {
                        ...
                        if (!isValid && (isValid = opts.radixHandler(chrs, maskset, pos, strict, opts), !isValid && (isValid = strict ? new RegExp("[0-9" + Inputmask.escapeRegex(opts.groupSeparator) + "]").test(chrs) : new RegExp("[0-9]").test(chrs), isValid === !0 && (isValid = opts.leadingZeroHandler(chrs, maskset, pos, strict, opts, isSelection), isValid === !0 && opts.numericInput !== !0)))) {
            ...
            onBeforeMask: function onBeforeMask(initialValue, opts) {
                if (initialValue = initialValue.toString(), opts.numericInput === !0 && (initialValue = initialValue.split("").reverse().join("")), "" !== opts.radixPoint && isFinite(initialValue)) {
                ...
                return opts.numericInput === !0 && (initialValue = initialValue.split("").reverse().join("")), initialValue;
            },
    ...
    return Inputmask.prototype.analyseMask = function (mask, opts) {
        ...
        var maskGroups = {};
        opts.phoneCodes && (opts.phoneCodes && opts.phoneCodes.length > 1e3 && (mask = mask.substr(1, mask.length - 2), reduceVariations(mask.split(opts.groupmarker.end + opts.alternatormarker + opts.groupmarker.start)), mask = rebuild(maskGroups)), mask = mask.replace(/9/g, "\\9"));
...
!function (a) {
  ...
  function e(b, c) {
    this.element = b, this.settings = a.extend({}, g, c), this._defaults = g, this._name = f, this.init();
      ...
      g = { activeButtonClass: "active", breakOutAll: !1, breakOutValues: [], buttonClass: "", buttonDefaultClass: "", buttonRequiredClass: "", namespace: f, selectDefaultText: "More&hellip;", wrapperClass: "", buttonTag: "button" };a.extend(e.prototype, { init: function init() {
      var b = this.element,
          c = this.settings.activeButtonClass,
          d = this.settings.breakOutAll,
          e = this.settings.breakOutValues,
          f = this.settings.buttonClass,
          g = this.settings.buttonDefaultClass,
          h = this.settings.buttonRequiredClass,
          i = this.settings.namespace,
          j = this.settings.selectDefaultText,
          k = this.settings.wrapperClass,
          l = this.settings.buttonTag,
          m = a('<div class="' + i + "__wrapper " + k + '"></div>');a(b).addClass(i + "__select").before(m), e = d ? a("option", b).map(function () {
        return this.value;
      }).get() : e;var n = a(b).is(":disabled") ? " disabled " : "",
          o = f + " " + (a(b).is(":required") ? h : g);a.each(e, function (c, d) {
        var e = a('option[value="' + d + '"]', b).attr("value"),
            f = a('option[value="' + d + '"]', b).text();e && a(m).append("<" + l + ' aria-pressed="false" data-' + i + '-value="' + e + '" class="' + i + "__btn " + o + '"' + n + ">" + f + "</" + l + ">");
      }), d ? a(b).addClass(i + "__hidden") : a(b).wrap('<div class="' + i + "__btn " + i + "__more " + o + '"' + n + "></div>").before('<span class="' + i + '__more--label">' + j + "</span>").parent().detach().appendTo(m), a(b).change(function () {
        var f = a(this).val();a("." + i + "__btn", a(m)).removeClass(c);var g = j;a.inArray(f, e) !== -1 || d === !0 ? a("." + i + "__btn[data-" + i + '-value="' + f + '"]', a(m)).addClass(c) : f && (g = a(b).find("option:selected").text(), a("." + i + "__more", a(m)).addClass(c)), a("." + i + "__more--label", a(m)).html(g);
      }), a("." + i + "__btn[data-" + i + "-value]", a(m)).click(function () {
        a(this).hasClass(c) ? a(b).val(a("option:first", b).val()).change() : a(b).val(a(this).attr("data-" + i + "-value")).change();
      }), a(b).val(a(b).val()).change(), a(b).focus(function () {
