...
namespace Thunderlabid\Notification\Valueobject;

use Thunderlabid\Notification\Valueobject\Interfaces\IValueObject;
use Thunderlabid\Notification\Valueobject\Traits\IValueObjectTrait;
use Exception;
