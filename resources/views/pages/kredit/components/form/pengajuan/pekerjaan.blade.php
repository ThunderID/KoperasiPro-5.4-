...
<fieldset class="form-group">
	...
	<div class="row">
		<div class="col-md-5">
			{!! Form::text('debitur[penghasilan_bersih]', (isset($param['data']['penghasilan_bersih']) ? $param['data']['penghasilan_bersih'] : null), ['id' => 'debitur_penghasilan_bersih', 'class' => 'form-control mask-money required auto-tabindex', 'placeholder' => 'Penghasilan bersih']) !!}
		</div>
	</div>
</fieldset>