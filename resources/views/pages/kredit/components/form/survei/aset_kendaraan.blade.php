...
<fieldset class="form-group">
	...
	<div class="row">
		<div class="col-md-5">
			{!! Form::select('aset_kendaraan[tipe]', $page_datas->select_jenis_kendaraan, (isset($param['data']['tipe']) && !is_null($param['data']['tipe'])) ? $param['data']['tipe'] : 'roda_2', ['class' => 'form-control quick-select auto-tabindex focus']) !!}
		</div>
	</div>
</fieldset>
<fieldset class="form-group">
