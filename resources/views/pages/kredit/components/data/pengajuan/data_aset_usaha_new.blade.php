		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left text-capitalize text-muted">
				<p class="m-b-xs text-capitalize">
					<span class="text-sm">aset usaha {{ $key+1 }}</span>
					...
					@if (!empty($page_datas->credit['survei_aset_usaha']))
						@if($edit == true)
							<span class="pull-right">
								...
								<a href="#aset-usaha" class="button-edit" data-toggle="hidden" data-target="aset-usaha-{{ $key }}" data-panel="data-aset" data-flag="data-aset-usaha" data-index="{{ $key }}" no-data-pjax>
