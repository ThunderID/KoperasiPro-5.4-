...
@if (isset($page_datas->credit['jaminan_tanah_bangunan']) && !empty($page_datas->credit['jaminan_tanah_bangunan']))
	@forelse($page_datas->credit['jaminan_tanah_bangunan'] as $key => $value)
		...
		@empty
			<div class="row m-b-md">
				<div class="col-sm-12">
					<p class="text-light">Belum ada data disimpan. <a href="#" data-toggle="hidden" data-target="survei-jaminan-tanah-bangunan" data-panel="survei-jaminan" no-data-pjax> Tambahkan Sekarang </a></p>
				</div>
			</div>
		@endforelse
	@empty
		...
		@else
			...
			<div class="row m-b-md">
				<div class="col-sm-12">
					<p class="text-light">Maaf data jaminan tidak ada</p>
				</div>
			</div>
		@endif
	@endforelse
	...
	{{-- @if ((count($page_datas->credit['jaminan_tanah_bangunan']) < 3) && count($page_datas->credit['jaminan_tanah_bangunan']) != 0) --}}
		<div class="row m-t-md m-b-md">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				@if ($page_datas->credit['status'] == 'pengajuan')
					<a href="#" data-toggle="hidden" data-target="survei-jaminan-tanah-bangunan" data-panel="survei-jaminan" no-data-pjax><i class="fa fa-plus"></i> Tambahkan Jaminan Tanah &amp; Bangunan</a>
				@endif
			</div>
		</div>
	{{-- @endif --}}
