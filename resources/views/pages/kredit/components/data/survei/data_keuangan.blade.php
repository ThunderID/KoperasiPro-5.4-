...
@if (isset($page_datas->credit['survei_keuangan']) && !empty($page_datas->credit['survei_keuangan']))
	@foreach ($page_datas->credit['survei_keuangan'] as $key => $value)
		<div class="row">
	...
	<div class="row m-t-md m-b-md">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<a href="#" data-toggle="hidden" data-target="keuangan" data-panel="data-keuangan" no-data-pjax><i class="fa fa-plus"></i> Tambahkan keuangan</a>
		</div>
	</div>
@else
	<!-- No data -->
