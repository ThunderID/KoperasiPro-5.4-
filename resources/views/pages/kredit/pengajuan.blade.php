...
@section('page_content')
	...
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.rencana_kredit')
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.data_pribadi')
		</div>
	</div>
   ...
   <!-- 3 Data Kelurga // -->
	<!-- <div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.data_keluarga',[
				'edit' => true
			])
		</div>
	</div>
   ...
   <!-- 4 Data Data Penjamin // -->
	<!-- <div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.data_penjamin',[
				'edit' => true
			])
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-6">
			@if(isset($page_datas->credit->finance))
				@include('pages.kredit.components.data_panels.data_keuangan')
			@endif
		</div>
		<div class="col-sm-6">
			@if(isset($page_datas->credit->asset))
				@include('pages.kredit.components.data_panels.data_aset')
			@endif
		</div>
	</div>
   ...
   <!-- BLOCK 7 Data Kelurga, Data Penjamin // -->
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.data_jaminan')
		</div>
	</div>
