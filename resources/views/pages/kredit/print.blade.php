...
@push('content')
	...
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.print_rencana_kredit')
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.print_data_pribadi')
		</div>
	</div>
   ...
   <!-- 3 Data Kelurga // -->
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.print_data_keluarga')
		</div>
	</div>
   ...
   <!-- 4 Data Data Penjamin // -->
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.print_data_penjamin')
		</div>
	</div>
   ...
   <!-- BLOCK 5 Data Jaminan // -->
	<div class="row">
		<div class="col-sm-12">
			@include('pages.kredit.components.data_panels.print_data_jaminan')
		</div>
	</div>
