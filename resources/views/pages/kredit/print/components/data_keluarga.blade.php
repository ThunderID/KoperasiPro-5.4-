<div class="row m-l-none m-r-none">
	<div class="col-sm-3 p-l-none p-r-none">
		<p class="text-sm text-capitalize">Hubungan Sebagai</p>
	</div>
		...
		<ul class="list-inline m-b-none">
			<li class="text-sm text-capitalize" style="width: 90px;">
				<p class="text-sm text-capitalize">
					: <input class="m-b-none" type="checkbox" value="roda_2" style="height: 11px;"> Orang Tua
				</p>
			</li>
			<li class="text-sm text-capitalize" style="width: 90px;">
				<p class="text-sm text-capitalize">
					<input class="m-b-none" type="checkbox" value="roda_4" style="height: 11px;"> Pasangan
				</p>
			</li>
			<li class="text-sm text-capitalize" style="width: 90px;">
				<p class="text-sm text-capitalize">
					<input class="m-b-none" type="checkbox" value="roda_6" style="height: 11px;"> Saudara
				</p>
			</li>
		</ul>
	</div>
