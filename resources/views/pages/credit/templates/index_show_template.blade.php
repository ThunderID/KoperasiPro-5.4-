...
@push('content')
	<div class="row field">
		<div class="col-sm-3 content-sidebar">
			...
			<div class="sidebar-content _window" data-padd-top="auto" data-padd-bottom="15">
		...
		<div class="col-sm-9">
			<div class="_window" data-padd-top="auto" data-padd-bottom="15" style="padding-top:16px;padding-bottom: 16px;overflow-y: auto;margin-right: -15px; padding-right: 16px;">
					@yield('page_content')
			</div>
		</div>
	</div>  
