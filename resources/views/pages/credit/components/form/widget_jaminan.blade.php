		...
		<div class="row">
			<div class="col-md-8 p-r-none">
				...
				<fieldset class="form-group">
					...
					<div class="row">
						<div class="col-md-12">
							{!! Form::select( (!is_null($param['prefix']) ? $param['prefix'] . '[collaterals]' : 'collaterals') . '[][type]', [
								'kendaraan'			=> 'Kendaraan',
				...
				<fieldset class="form-group">
					...
					<div class="row">
						<div class="col-md-12">
							{!! Form::text( (!is_null($param['prefix']) ? $param['prefix'] . '[collaterals]' : 'collaterals') . '[][ownership_status]', null, ['class' => 'form-control required auto-tabindex', 'placeholder' => 'Pemilik jaminan']) !!}
						</div>
					</div>
				</fieldset>
				<fieldset class="form-group">
					...
					<div class="row">
						<div class="col-md-12">
							...
							{!! Form::hidden( (!is_null($param['prefix']) ? $param['prefix'] . '[collaterals]' : 'collaterals') . '[][legal]', null, ['class' => 'credit-collaterals-legal']) !!}
						</div>
					</div>
				</fieldset>
			</div>
