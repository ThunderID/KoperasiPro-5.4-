...
@section('content')
	<div class="row" style="padding-top: 20px;">
			...
			<div class="list-group">
				@foreach($kredit as $key => $value)
					<a href="#" class="list-group-item">
						<h4 class="list-group-item-heading">{{$value->nasabah->nama}} <span class="badge">{{$value->statusTerbaru()->status}}</span></h4>
		...
		<div class="col-sm-9">
			<h3 style="margin-top: 5px">Data Nasabah</h3>
			<hr/>
			<h5>Nama</h5>
			<p>{{$kredit_detail->nasabah->nama}}</p>
			<br/>
		</div>
	</div>
@endsection