	...
	<body>
		<div class="container" style="width: 21cm;height: 29.7cm; ">
			<div class="row text-center">
				<div class="col-sm-12">
					<h1>SURAT PERNYATAAN SEBAGAI PENJAMIN</h1>
				</div> 
			</div> 
			...
			<div class="row text-justify">
				<div class="col-sm-12">
					...
					<p>
						Menerangkan :<br/>
						Bahwa {{$kredit['kreditur']['nama']}} (selanjutnya disebut Debitur) telah memperoleh fasilitas kredit dari Pihak Kedua, sejumlah {{$kredit['pengajuan_kredit']}} (........................) sebagaimana tersebut dalam Perjanjian Kredit Nomer ........, tanggal...................... ;
