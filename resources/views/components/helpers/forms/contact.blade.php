	...
	<fieldset class="form-group">
		...
		<div class="row">
			<div class="col-xs-12 col-md-5">
				{!! Form::text( (!is_null($param['prefix']) ? $param['prefix'] . '[telepon]' : 'telepon'), (isset($param['data']) ? $param['data'] : null), ['id' => (!is_null($param['prefix']) ? $param['prefix'] . '[telepon]' : 'telepon'), 'class' => 'form-control required auto-tabindex', 'placeholder' => 'Ex. 0341 2339 9001']) !!}
			</div>
